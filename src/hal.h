...
// Ripped straight from https://github.com/ISSUIUC/MIDAS-Software/blob/eaf65f7ad4c07fea6e4dd306f7a1816c8391d3b5/MIDAS/src/Mutex.h
// You know it would be nice if we didn't have to copy header files left and right
// If only we had a way that enabled us to link all the different files in the different repos together
// like a monorepo and we used some silly build system like bazel. But that will never happen
#include <Arduino.h>
